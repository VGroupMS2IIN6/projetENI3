...
$db = "projet_eni" # nom de la base de donnée
...
Function MakeForm {
    ...
    $ButtonDefProfils.Text = "Dꧩnition des profils"
...
Function MakeMenuPlateformes {
    ...
    $labelRegexMdp.Text = "Regex de gꯩration du mot de passe"
