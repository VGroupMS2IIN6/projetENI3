...
function creationAd 
{
    ...
    New-ADUser -Name $($StagPrenom + $StagNom) -surname $StagNom -GivenName $StagPrenom -SamAccountName $StagSAMAN -Server "NomDomainStag" -AccountPassword $SecStagPassTemp -Credential $creds -whatif
